...
async def lifespan(app: FastAPI):
    ...
    async with engine.begin() as conn:
        ...
        await conn.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS education JSON;"))
        await conn.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS work_experience JSON;"))
